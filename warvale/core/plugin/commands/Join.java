               	...
               	switch (args[0]) {
            		case "blue":
						if (Main.getBlueTeam().getEntries().contains(sender.getName())) {
          					sender.sendMessage(ChatColor.GRAY + "You're already on the " + ChatColor.DARK_AQUA + "blue team");
                          	return true;
          				} else {
          					//Join the team
					...
					default:
                        sender.sendMessage(ChatColor.GRAY + "Incorrect usage. Correct usage: /join <" + ChatColor.RED + "red" + ChatColor.GRAY + "/" + ChatColor.DARK_AQUA + "blue" + ChatColor.GRAY + ">");
						return true;
          		}
            } else {
            	sender.sendMessage(ChatColor.GRAY + "Incorrect usage. Correct usage: /join <" + ChatColor.RED + "red" + ChatColor.GRAY + "/" + ChatColor.DARK_AQUA + "blue" + ChatColor.GRAY + ">");
